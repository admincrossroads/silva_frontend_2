  ...
  return (
    <div className="min-h-screen bg-[hsl(165_28%_8%)] text-[hsl(150_18%_96%)]">
      ...
      <section id="how-it-works" className="scroll-mt-20 bg-[hsl(155_18%_97%)] px-5 py-20 text-[hsl(160_28%_14%)] md:px-8 md:py-28">
        <div className="mx-auto max-w-6xl xl:max-w-7xl 2xl:max-w-[90rem] 3xl:max-w-content-xl">
          ...
          <p className="mt-4 max-w-xl text-base leading-relaxed text-[hsl(160_12%_38%)]">
            Asset owners, program managers, and field partners share one estate workspace with clear role firewalls.
          </p>
      ...
      <section className="bg-[hsl(155_18%_97%)] px-5 py-20 text-[hsl(160_28%_14%)] md:px-8 md:py-28">
        <div className="mx-auto max-w-6xl xl:max-w-7xl 2xl:max-w-[90rem] 3xl:max-w-content-xl">
          <p className="text-[11px] font-medium uppercase tracking-[0.2em] text-primary">Who it serves</p>
          <h2 className="mt-3 font-display text-3xl tracking-tight md:text-4xl">Three desks on one estate</h2>
          <p className="mt-4 max-w-xl text-base leading-relaxed text-[hsl(160_12%_38%)]">
            Sign in with your workspace account. Demo users are already seeded for Silva, SPX, and B-Agro.
          </p>
          ...
          <div className="mt-10 divide-y divide-[hsl(150_14%_86%)] overflow-hidden rounded-2xl bg-white ring-1 ring-[hsl(150_14%_86%)]">
            {[
              ...
              },
              {
                ...
                role: "SPX principal desk",
                copy: "Authorize AFEs, issue work, validate tickets, and release reports.",
              },
              {
              ...
              <div
                key={row.type}
                className="flex flex-col gap-2 px-5 py-6 sm:flex-row sm:items-center sm:justify-between sm:gap-6 sm:px-7"
              >
      ...
      <section className="relative overflow-hidden px-5 py-24 md:px-8 md:py-28">
        ...
        <div className="relative z-10 mx-auto max-w-2xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-md text-base leading-relaxed text-white/60">
            Sign in with your Silva, SPX, or B-Agro workspace account to open the program desk.
          </p>

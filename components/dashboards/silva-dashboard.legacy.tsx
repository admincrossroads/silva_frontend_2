...
/**
 * LEGACY Silva owner dashboard (pre owner-desk cleanup).
 * Kept for easy revert: swap export in dashboard page or replace
 * `silva-dashboard.tsx` contents with this file's `SilvaDashboardLegacy`.
 */
...
export function SilvaDashboardLegacy() {
